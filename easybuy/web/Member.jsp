...
<div class="soubg">
    <div class="sou">
        ...
        <c:if test="${sessionScope.user.userName!=null}"><a href="Member.jsp">${sessionScope.user.userName}</a></c:if>&nbsp; <a href="Regist.jsp" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="/myOrder">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="m_top_bg">
    <div class="top">
        <div class="logo"><a href="index.jsp"><img src="images/logo1.png" /></a></div>
        <div class="m_search">
            <form>
