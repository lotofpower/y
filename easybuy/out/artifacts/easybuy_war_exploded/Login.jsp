        ...
        <div class="log_c">
            <form  method="post" action="/Login">
                <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="70">
                        <td>密&nbsp; &nbsp; 码</td>
                        <td><input  id="password" name="password" type="password" value=""   class="l_pwd" /></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr height="60">
                        <td>&nbsp;</td>
                        <td><input type="submit" value="登录" name="sub" onclick="test()" class="log_btn"></td>
                    </tr>
                </table>
            </form>
        </div>
...
<script type="text/javascript">
    function test() {
        history.go(-1);
        if(($("#loginName")[0].value == 0||0 == $("#password")[0].value )){
            alert("请输入账号或密码");
            location.href="Login.jsp"
        }

        $.ajax(
            {url:"/Login",async:true,success:function(result){
                    $().go(-1);
                }});
